...
function SCRIPT_filter_outliers(set, prm)
...
number_of_items_in_legend = min(20, size(text,2))
text = text(1:number_of_items_in_legend)
text(number_of_items_in_legend)={'........'}
ax = gca;
ax.YDir = 'reverse';
