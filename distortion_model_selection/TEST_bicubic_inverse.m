...
width = 2048;
height = 2048;
exel_filename  = 'data/Optical-distortion-predict.xlsx';
...
x_dist = exel_tab(1:25,3);
y_dist = exel_tab(1:25,4);
x_ideal = exel_tab(1:25,5);
y_ideal = exel_tab(1:25,6);
...
[x, y, i, j] = simulate_distortion_field(@undistort_bicubic, param, image_size, pixel_size*1000);
